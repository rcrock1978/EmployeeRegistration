...
public sealed record RegisterMemberCommand(
    ...
    ConsentDto Consent
) : ICommand<RegisterMemberResponse>;

public sealed record RegisterMemberResponse(Guid Id);
...
public sealed record RelatedPersonsDto(
    SpouseDto? Spouse,
    string? MotherMaidenName,
    FatherDto? Father
);

public sealed record SpouseDto(
    string FirstName,
    string? MiddleName,
    string LastName
);

public sealed record FatherDto(
    string FirstName,
    string? MiddleName,
    string LastName,
    string? Suffix
...
public sealed record GovernmentIdsDto(
    string Tin,
    string Sss
);

public sealed record PrimaryIdDto(
    string Type,
    string Number,
    DateTime IssueDate,
    DateTime ExpiryDate,
...
public sealed record AddressDto(
    ...
    string PostalCode,
    string Barangay,
    string? SubdivisionPurok,
    string Province,
    string Country,
    string OwnerOrLessee,
    DateTime OccupiedSince
);

public sealed record PermanentAddressDto(
    bool SameAsCurrent,
    AddressDto? Address
);
